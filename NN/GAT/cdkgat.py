...
class Model(nn.Module):
    def __init__(self):
        ...
        self.conv1 = GATConv(47, 512,  heads=5)
        self.conv2 = GATConv(5 * 512, 512, heads=5)
        self.conv3 = GATConv(5 * 512, 512, heads=1)
...
def ntimecrossvalidation(n=5):
    ...
    pickle.dump(all_records, open('./new_all_records_cdk.pkl', 'wb'))

args = {
    'lr': 0.01,
    'epoch': 500,
    'seed': 42,
    'save_path': './cdkmodel2/model',
    'momentum':0.9,
    'weight_decay': 1e-7,
    'pos_weight': 3
}
...
with open('./time.txt', 'a') as f:
    f.write('new cdk spend time ' + str(endtime) + '\n')
