...
mols = pickle.load(open('../../raw_database/rdkit.pkl', 'rb'))
dataset = []
for mol in mols:
    g = mol[0]
    y = mol[1]
...
class Model(nn.Module):
    def __init__(self):
        ...
        self.conv1 = ChebConv(28, 1024, 3)
        self.conv2 = ChebConv(1024, 1024, 3)
        self.conv3 = ChebConv(1024, 1024, 3)
...
with open('./time.txt', 'a') as f:
    f.write('new rdkit feature spend' + str(endtime) + '/n')
